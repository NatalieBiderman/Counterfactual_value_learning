...
if (Save_plots == 1) {ggsave(filename=sprintf("../results/Plots/%s.%s","Figure2_new",fig_type), 
                             plot=p, 
                             width=fig_size[1]+4,
                             height=fig_size[2]+4)}
...
![Figure2. The inferred value of unchosen options is inversely related to the learned value of chosen options (Experiment 1)](../results/Plots/Figure2_new.png) 
